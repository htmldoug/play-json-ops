...
private[ops] class ImplicitTupleFormats {
  ...
  implicit def tuple2Reads[A: Reads, B: Reads]: Reads[(A, B)] = {
    _.validate[Iterable[JsValue]] flatMap {
      case Seq(_1, _2) =>
        val a = _1.validate[A]
        val b = _2.validate[B]
  ...
  implicit def tuple2Writes[A: Writes, B: Writes]: Writes[(A, B)] = { o =>
    JsArray(Seq(
      Json.toJson(o._1),
      Json.toJson(o._2)
    ))
  ...
  implicit def tuple4Writes[A: Writes, B: Writes, C: Writes, D: Writes]: Writes[(A, B, C, D)] = { o =>
    JsArray(Seq(
      Json.toJson(o._1),
      Json.toJson(o._2),
      Json.toJson(o._3),
  ...
  implicit def tuple5Writes[A: Writes, B: Writes, C: Writes, D: Writes, E: Writes]: Writes[(A, B, C, D, E)] = { o =>
    JsArray(Seq(
      Json.toJson(o._1),
      Json.toJson(o._2),
      Json.toJson(o._3),
  ...
  A: Writes, B: Writes, C: Writes, D: Writes, E: Writes,
  F: Writes, G: Writes]: Writes[(A, B, C, D, E, F, G)] = { o =>
    JsArray(Seq(
      Json.toJson(o._1),
      Json.toJson(o._2),
      Json.toJson(o._3),
  ...
  A: Writes, B: Writes, C: Writes, D: Writes, E: Writes,
  F: Writes, G: Writes, H: Writes]: Writes[(A, B, C, D, E, F, G, H)] = { o =>
    JsArray(Seq(
      Json.toJson(o._1),
      Json.toJson(o._2),
      Json.toJson(o._3),
  ...
  A: Writes, B: Writes, C: Writes, D: Writes, E: Writes,
  F: Writes, G: Writes, H: Writes, I: Writes]: Writes[(A, B, C, D, E, F, G, H, I)] = { o =>
    JsArray(Seq(
      Json.toJson(o._1),
      Json.toJson(o._2),
      Json.toJson(o._3),
  ...
  A: Writes, B: Writes, C: Writes, D: Writes, E: Writes,
  F: Writes, G: Writes, H: Writes, I: Writes, J: Writes]: Writes[(A, B, C, D, E, F, G, H, I, J)] = { o =>
    JsArray(Seq(
      Json.toJson(o._1),
      Json.toJson(o._2),
      Json.toJson(o._3),
